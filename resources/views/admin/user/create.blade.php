  ...
  <div class="bg-light p-5 rounded">
    ...
    <form action="{{route('user.store')}}" method="post" class="px-md-5" enctype="multipart/form-data">
      ...
      <div class="form-group mb-3 row">
        ...
        <div class="col-md-10">
          <input type="text" placeholder="name" name="name" class="form-control py-2" value="{{old('name')}}" />
        </div>
      </div>
      <div class="form-group mb-3 row">
        @error('email')
        ...
        <div class="col-md-10">
          <input type="text" placeholder="email" name="email" class="form-control py-2" value="{{old('email')}}" />
        </div>
      </div>
      ...
      <div class="form-group mb-3 row">
        ...
        <div class="col-md-10">
            <input type="checkbox" name="active" class="form-check-input" style="padding: 0.7rem;" value="1" @checked(old('active')==1)/>
        </div>
      </div>
      <hr>
