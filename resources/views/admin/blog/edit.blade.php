...
<div class="container my-5">
  <div class="bg-light p-5 rounded">
    <h2 class="fw-bold fs-2 mb-5 pb-2">Edit Blog</h2>
    <form action="{{route('blog.update',$data)}}" method="post" class="px-md-5" enctype="multipart/form-data">
      @csrf
      @method('put')
      ...
      <div class="form-group mb-3 row">
        ...
        <div class="row "><div class="col-md-3"><img src="{{ asset('assets/images/blog/'.$data->image) }}" alt="{{ $data->title }}" ></div></div>
